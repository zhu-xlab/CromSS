...
from py_scripts_SSL4EO.get_args_pretrain_sscom import get_args
from models.pl_pretrain_mm_sscom import Unet_mm
...
def main():
    ...
    ###### 1 - parameter setting ######
    global args
    args = get_args(multi_modal=True)
    # resume option
    if args.resume and not args.prt:
    ...
    wandb_logger = WandbLogger(project=args.pjn, entity=args.entity, 
                               ...
                               name=f'm{args.mcr}_s{args.seed}_b{args.bs}',
                               save_dir=args.pdir,
                               resume=wandb_resume)  
    ...
    ###### 2 - load data ######
    # file directories
    lmdb_s1 = os.path.join(args.data_path, args.dn1)
    lmdb_s2 = os.path.join(args.data_path, args.dn2)
    ...
    dataset = SSL4EODataset(lmdb_file_ns=lmdb_lb, 
                            lmdb_file_s1=lmdb_s1, 
                            lmdb_file_s2=lmdb_s2,
                            mode=args.it,
                            ...
                            smooth_prior_type=args.ls_prior_type)
    ...
    if args.val == 0:
        ...
        # train_set, _ = split_for_train_and_val_sets(train_set, 0.95, seed=args.seed)
    ...
    ###### 4 - train the model ######
    print('\nStart training...')
    callbacks = [ModelCheckpoint(dirpath = args.checkpoints_dir, every_n_epochs = args.save_inv, # save_weights_only=True, 
