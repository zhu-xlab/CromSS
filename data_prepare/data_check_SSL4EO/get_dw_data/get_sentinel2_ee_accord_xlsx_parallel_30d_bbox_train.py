...
def get_single_s2_data_from_ee(ds, save_dir, download_l2a=False):  
    ...
    try:
        try:
            # current day + 15 days
            image = clip_img_with_bbox(bbox, crs, formatted_date_string, formatted_date_string_after, l2a=download_l2a)
        except:
            # current day - 15 days
            image = clip_img_with_bbox(bbox, crs, formatted_date_string_before, formatted_date_string, l2a=download_l2a)
        return image
...
def get_s2_for_each_split_tif(args):
    ...
    for i in range(n_sam):
        ds = df.loc[i]
        did = df.loc[i,'dw_id']
        image = get_single_s2_data_from_ee(ds, save_dir, download_l2a)
...
if __name__ == '__main__':
    label_file_path = '/p/project1/hai_ws4eo/liu_ch/DW/test/data_v1/download_s2/center_voids_expert.csv'
    ...
    save_dir = '/p/project1/hai_ws4eo/liu_ch/DW/test/data_v2/download_s2a'
